package me.hsgamer.bettergui.bettermaterial.lib;
...
public enum UMaterial implements Versionable {
  ...
  */
  ...
  BLACK_STAINED_GLASS_PANE(15, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  BLUE_STAINED_GLASS_PANE(11, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  BROWN_STAINED_GLASS_PANE(12, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  CYAN_STAINED_GLASS_PANE(9, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  ENCHANTED_BOOK_CHANNELING("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("CHANNELING") != null ? "CHANNELING" : "PROTECTION_EXPLOSIONS"), 1),
  ENCHANTED_BOOK_CURSE_OF_BINDING("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("BINDING_CURSE") != null ? "BINDING_CURSE" : "PROTECTION_EXPLOSIONS"),
      1),
  ENCHANTED_BOOK_CURSE_OF_VANISHING("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("VANISHING_CURSE") != null ? "VANISHING_CURSE"
  ...
  ENCHANTED_BOOK_FROST_WALKER_1("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("FROST_WALKER") != null ? "FROST_WALKER" : "LOOT_BONUS_BLOCKS"), 1),
  ENCHANTED_BOOK_FROST_WALKER_2("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("FROST_WALKER") != null ? "FROST_WALKER" : "LOOT_BONUS_BLOCKS"), 2),
  ENCHANTED_BOOK_IMPALING_1("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 1),
  ENCHANTED_BOOK_IMPALING_2("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 2),
  ENCHANTED_BOOK_IMPALING_3("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 3),
  ENCHANTED_BOOK_IMPALING_4("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 4),
  ENCHANTED_BOOK_IMPALING_5("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 5),
  ...
  ENCHANTED_BOOK_LOYALTY_1("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 1),
  ENCHANTED_BOOK_LOYALTY_2("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 2),
  ENCHANTED_BOOK_LOYALTY_3("ENCHANTED_BOOK", Enchantment
      .getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 3),
  ...
  ENCHANTED_BOOK_MULTI_SHOT("ENCHANTED_BOOK",
      Enchantment.getByName(Enchantment.getByName("MULTI_SHOT") != null ? "MULTI_SHOT" : "LURE"),
      1),
  ...
  ENCHANTED_BOOK_QUICK_CHARGE_1("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"), 1),
  ENCHANTED_BOOK_QUICK_CHARGE_2("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"), 2),
  ENCHANTED_BOOK_QUICK_CHARGE_3("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"), 3),
  ...
  ENCHANTED_BOOK_SWEEPING_EDGE_1("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"), 1),
  ENCHANTED_BOOK_SWEEPING_EDGE_2("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"), 2),
  ENCHANTED_BOOK_SWEEPING_EDGE_3("ENCHANTED_BOOK", Enchantment.getByName(
      Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"), 3),
  ...
  GLOWING_REDSTONE_ORE("GLOWING_REDSTONE_ORE", null, null, null, null,
  ...
  GRAY_STAINED_GLASS_PANE(7, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  GREEN_STAINED_GLASS_PANE(13, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  HEAVY_WEIGHTED_PRESSURE_PLATE("IRON_PLATE", null, null, null, null,
  ...
  ICE("ICE"),
  INFESTED_CHISELED_STONE_BRICKS(5, "MONSTER_EGGS", null, null, null, null,
      "INFESTED_CHISELED_STONE_BRICKS"),
  INFESTED_COBBLESTONE(1, "MONSTER_EGGS", null, null, null, null, "INFESTED_COBBLESTONE"),
  INFESTED_CRACKED_STONE_BRICKS(4, "MONSTER_EGGS", null, null, null, null,
      "INFESTED_CRACKED_STONE_BRICKS"),
  INFESTED_MOSSY_STONE_BRICKS(3, "MONSTER_EGGS", null, null, null, null,
  ...
  LIGHT_BLUE_CONCRETE_POWDER(3, null, null, null, null, "CONCRETE_POWDER",
  ...
  LIGHT_BLUE_STAINED_GLASS_PANE(3, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  LIGHT_GRAY_CONCRETE_POWDER(8, null, null, null, null, "CONCRETE_POWDER",
      "LIGHT_GRAY_CONCRETE_POWDER"),
  LIGHT_GRAY_DYE(7, "INK_SACK", null, null, null, null, "LIGHT_GRAY_DYE"),
  LIGHT_GRAY_GLAZED_TERRACOTTA(null, null, null, null, "SILVER_GLAZED_TERRACOTTA",
  ...
  LIGHT_GRAY_STAINED_GLASS_PANE(8, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  LIGHT_WEIGHTED_PRESSURE_PLATE("GOLD_PLATE", null, null, null, null,
  ...
  LIME_STAINED_GLASS_PANE(5, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  LINGERING_POTION_FIRE_RESISTANCE(PotionBase.LINGERING, "FIRE_RESISTANCE", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_FIRE_RESISTANCE_EXTENDED(PotionBase.LINGERING, "FIRE_RESISTANCE", true, false,
      null, "LINGERING_POTION"),
  LINGERING_POTION_HARMING_1(PotionBase.LINGERING, "INSTANT_DAMAGE", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_HARMING_2(PotionBase.LINGERING, "INSTANT_DAMAGE", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_HEALING_1(PotionBase.LINGERING, "INSTANT_HEAL", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_HEALING_2(PotionBase.LINGERING, "INSTANT_HEAL", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_INVISIBILITY(PotionBase.LINGERING, "INVISIBILITY", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_INVISIBILITY_EXTENDED(PotionBase.LINGERING, "INVISIBILITY", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_LEAPING_1(PotionBase.LINGERING, "JUMP", false, false, null, "LINGERING_POTION"),
  LINGERING_POTION_LEAPING_1_EXTENDED(PotionBase.LINGERING, "JUMP", true, false, null,
      "LINGERING_POTION"),
  ...
  LINGERING_POTION_NIGHT_VISION(PotionBase.LINGERING, "NIGHT_VISION", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_NIGHT_VISION_EXTENDED(PotionBase.LINGERING, "NIGHT_VISION", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_POISON_1(PotionBase.LINGERING, "POISON", false, false, null, "LINGERING_POTION"),
  LINGERING_POTION_POISON_1_EXTENDED(PotionBase.LINGERING, "POISON", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_POISON_2(PotionBase.LINGERING, "POISON", false, true, null, "LINGERING_POTION"),
  LINGERING_POTION_REGENERATION_1(PotionBase.LINGERING, "REGEN", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_REGENERATION_1_EXTENDED(PotionBase.LINGERING, "REGEN", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_REGENERATION_2(PotionBase.LINGERING, "REGEN", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SLOW_FALLING(PotionBase.LINGERING, "SLOW_FALLING", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SLOW_FALLING_EXTENDED(PotionBase.LINGERING, "SLOW_FALLING", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SLOWNESS_1(PotionBase.LINGERING, "SLOWNESS", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SLOWNESS_1_EXTENDED(PotionBase.LINGERING, "SLOWNESS", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SLOWNESS_2(PotionBase.LINGERING, "SLOWNESS", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_STRENGTH_1(PotionBase.LINGERING, "STRENGTH", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_STRENGTH_1_EXTENDED(PotionBase.LINGERING, "STRENGTH", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_STRENGTH_2(PotionBase.LINGERING, "STRENGTH", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SWIFTNESS_1(PotionBase.LINGERING, "SPEED", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SWIFTNESS_1_EXTENDED(PotionBase.LINGERING, "SPEED", true, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_SWIFTNESS_2(PotionBase.LINGERING, "SPEED", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_THICK(PotionBase.LINGERING, "THICK", false, false, null, "LINGERING_POTION"),
  LINGERING_POTION_TURTLE_MASTER_1(PotionBase.LINGERING, "TURTLE_MASTER", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_TURTLE_MASTER_1_EXTENDED(PotionBase.LINGERING, "TURTLE_MASTER", true, false,
      null, "LINGERING_POTION"),
  LINGERING_POTION_TURTLE_MASTER_2(PotionBase.LINGERING, "TURTLE_MASTER", false, true, null,
      "LINGERING_POTION"),
  LINGERING_POTION_WATER(PotionBase.LINGERING, "WATER", false, false, null, "LINGERING_POTION"),
  LINGERING_POTION_WATER_BREATHING(PotionBase.LINGERING, "WATER_BREATHING", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_WATER_BREATHING_EXTENDED(PotionBase.LINGERING, "WATER_BREATHING", true, false,
      null, "LINGERING_POTION"),
  LINGERING_POTION_WEAKNESS(PotionBase.LINGERING, "WEAKNESS", false, false, null,
      "LINGERING_POTION"),
  LINGERING_POTION_WEAKNESS_EXTENDED(PotionBase.LINGERING, "WEAKNESS", true, false, null,
      "LINGERING_POTION"),
  ...
  MAGENTA_STAINED_GLASS_PANE(2, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  ORANGE_STAINED_GLASS_PANE(1, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  PINK_STAINED_GLASS_PANE(6, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  PURPLE_STAINED_GLASS_PANE(10, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  RED_STAINED_GLASS_PANE(14, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  REPEATING_COMMAND_BLOCK("COMMAND", "COMMAND_REPEATING", null, null, null,
  ...
  SPLASH_POTION_FIRE_RESISTANCE(PotionBase.SPLASH, "FIRE_RESISTANCE", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_FIRE_RESISTANCE_EXTENDED(PotionBase.SPLASH, "FIRE_RESISTANCE", true, false,
      "POTION", "SPLASH_POTION"),
  SPLASH_POTION_HARMING_1(PotionBase.SPLASH, "INSTANT_DAMAGE", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_HARMING_2(PotionBase.SPLASH, "INSTANT_DAMAGE", false, true, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_HEALING_1(PotionBase.SPLASH, "INSTANT_HEAL", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_HEALING_2(PotionBase.SPLASH, "INSTANT_HEAL", false, true, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_INVISIBILITY(PotionBase.SPLASH, "INVISIBILITY", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_INVISIBILITY_EXTENDED(PotionBase.SPLASH, "INVISIBILITY", true, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_LEAPING_1(PotionBase.SPLASH, "JUMP", false, false, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_LEAPING_1_EXTENDED(PotionBase.SPLASH, "JUMP", true, false, "POTION",
      "SPLASH_POTION"),
  ...
  SPLASH_POTION_NIGHT_VISION(PotionBase.SPLASH, "NIGHT_VISION", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_NIGHT_VISION_EXTENDED(PotionBase.SPLASH, "NIGHT_VISION", true, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_POISON_1(PotionBase.SPLASH, "POISON", false, false, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_POISON_1_EXTENDED(PotionBase.SPLASH, "POISON", true, false, "POTION",
      "SPLASH_POTION"),
  ...
  SPLASH_POTION_REGENERATION_1_EXTENDED(PotionBase.SPLASH, "REGEN", true, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_REGENERATION_2(PotionBase.SPLASH, "REGEN", false, true, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_SLOW_FALLING(PotionBase.SPLASH, "SLOW_FALLING", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_SLOW_FALLING_EXTENDED(PotionBase.SPLASH, "SLOW_FALLING", true, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_SLOWNESS_1(PotionBase.SPLASH, "SLOWNESS", false, false, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_SLOWNESS_1_EXTENDED(PotionBase.SPLASH, "SLOWNESS", true, false, "POTION",
      "SPLASH_POTION"),
  ...
  SPLASH_POTION_STRENGTH_1_EXTENDED(PotionBase.SPLASH, "STRENGTH", true, false, "POTION",
      "SPLASH_POTION"),
  ...
  SPLASH_POTION_SWIFTNESS_1_EXTENDED(PotionBase.SPLASH, "SPEED", true, false, "POTION",
      "SPLASH_POTION"),
  ...
  SPLASH_POTION_TURTLE_MASTER_1(PotionBase.SPLASH, "TURTLE_MASTER", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_TURTLE_MASTER_1_EXTENDED(PotionBase.SPLASH, "TURTLE_MASTER", true, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_TURTLE_MASTER_2(PotionBase.SPLASH, "TURTLE_MASTER", false, true, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_WATER(PotionBase.SPLASH, "WATER", false, false, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_WATER_BREATHING(PotionBase.SPLASH, "WATER_BREATHING", false, false, "POTION",
      "SPLASH_POTION"),
  SPLASH_POTION_WATER_BREATHING_EXTENDED(PotionBase.SPLASH, "WATER_BREATHING", true, false,
      "POTION", "SPLASH_POTION"),
  SPLASH_POTION_WEAKNESS(PotionBase.SPLASH, "WEAKNESS", false, false, "POTION", "SPLASH_POTION"),
  SPLASH_POTION_WEAKNESS_EXTENDED(PotionBase.SPLASH, "WEAKNESS", true, false, "POTION",
      "SPLASH_POTION"),
  SPONGE("SPONGE"),
  ...
  TIPPED_ARROW_FIRE_RESISTANCE(PotionBase.TIPPED_ARROW, "FIRE_RESISTANCE", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_FIRE_RESISTANCE_EXTENDED(PotionBase.TIPPED_ARROW, "FIRE_RESISTANCE", true, false,
      "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_HARMING_1(PotionBase.TIPPED_ARROW, "INSTANT_DAMAGE", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_HARMING_2(PotionBase.TIPPED_ARROW, "INSTANT_DAMAGE", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_HEALING_1(PotionBase.TIPPED_ARROW, "INSTANT_HEAL", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_HEALING_2(PotionBase.TIPPED_ARROW, "INSTANT_HEAL", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_INVISIBILITY(PotionBase.TIPPED_ARROW, "INVISIBILITY", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_INVISIBILITY_EXTENDED(PotionBase.TIPPED_ARROW, "INVISIBILITY", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_LEAPING_1(PotionBase.TIPPED_ARROW, "JUMP", false, false, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_LEAPING_1_EXTENDED(PotionBase.TIPPED_ARROW, "JUMP", true, false, "ARROW",
      "TIPPED_ARROW"),
  ...
  TIPPED_ARROW_NIGHT_VISION(PotionBase.TIPPED_ARROW, "NIGHT_VISION", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_NIGHT_VISION_EXTENDED(PotionBase.TIPPED_ARROW, "NIGHT_VISION", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_POISON_1(PotionBase.TIPPED_ARROW, "POISON", false, false, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_POISON_1_EXTENDED(PotionBase.TIPPED_ARROW, "POISON", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_POISON_2(PotionBase.TIPPED_ARROW, "POISON", false, true, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_REGENERATION_1(PotionBase.TIPPED_ARROW, "REGEN", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_REGENERATION_1_EXTENDED(PotionBase.TIPPED_ARROW, "REGEN", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_REGENERATION_2(PotionBase.TIPPED_ARROW, "REGEN", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SLOW_FALLING(PotionBase.TIPPED_ARROW, "SLOW_FALLING", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SLOW_FALLING_EXTENDED(PotionBase.TIPPED_ARROW, "SLOW_FALLING", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SLOWNESS_1(PotionBase.TIPPED_ARROW, "SLOWNESS", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SLOWNESS_1_EXTENDED(PotionBase.TIPPED_ARROW, "SLOWNESS", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SLOWNESS_2(PotionBase.TIPPED_ARROW, "SLOWNESS", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_STRENGTH_1(PotionBase.TIPPED_ARROW, "STRENGTH", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_STRENGTH_1_EXTENDED(PotionBase.TIPPED_ARROW, "STRENGTH", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_STRENGTH_2(PotionBase.TIPPED_ARROW, "STRENGTH", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SWIFTNESS_1(PotionBase.TIPPED_ARROW, "SPEED", false, false, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_SWIFTNESS_1_EXTENDED(PotionBase.TIPPED_ARROW, "SPEED", true, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_SWIFTNESS_2(PotionBase.TIPPED_ARROW, "SPEED", false, true, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_TURTLE_MASTER_1(PotionBase.TIPPED_ARROW, "TURTLE_MASTER", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_TURTLE_MASTER_1_EXTENDED(PotionBase.TIPPED_ARROW, "TURTLE_MASTER", true, false,
      "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_TURTLE_MASTER_2(PotionBase.TIPPED_ARROW, "TURTLE_MASTER", false, true, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_WATER_BREATHING(PotionBase.TIPPED_ARROW, "WATER_BREATHING", false, false, "ARROW",
      "TIPPED_ARROW"),
  TIPPED_ARROW_WATER_BREATHING_EXTENDED(PotionBase.TIPPED_ARROW, "WATER_BREATHING", true, false,
      "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_WEAKNESS(PotionBase.TIPPED_ARROW, "WEAKNESS", false, false, "ARROW", "TIPPED_ARROW"),
  TIPPED_ARROW_WEAKNESS_EXTENDED(PotionBase.TIPPED_ARROW, "WEAKNESS", true, false, "ARROW",
      "TIPPED_ARROW"),
  TNT("TNT"),
  ...
  WHITE_STAINED_GLASS_PANE("STAINED_GLASS_PANE", null, null, null, null,
  ...
  YELLOW_STAINED_GLASS_PANE(4, "STAINED_GLASS_PANE", null, null, null, null,
  ...
  public static ItemStack getEnchantmentBook(LinkedHashMap<Enchantment, Integer> enchants,
      int amount) {
  ...
  public static ItemStack valueOf(String name, byte data) {
    name = name.toUpperCase();
    if (inMemory.containsKey(name + data)) {
  ...
  public static UMaterial matchSpawnEgg(ItemStack egg) {
    if (egg != null) {
      if (EIGHT) {
        ...
        final String id =
            egg.hasItemMeta() ? egg.getItemMeta().toString().split("id=")[1].split("}")[0]
                .toUpperCase() : "PIG";
  ...
  public static UMaterial matchPotion(ItemStack potion) {
    if (potion != null && potion.getItemMeta() instanceof PotionMeta) {
      ...
      if (ce.size() == 0) {
        ...
        if (type != null) {
          final String g =
              base + type + (max != 1 && l <= max ? "_" + l : "") + (extended ? "_EXTENDED" : "");
          return valueOf(g);
        } else {
    ...
    if (item != null && !item.getType().equals(Material.AIR)) {
      ...
      return un != null ? un.contains("SPAWN_EGG") ? matchSpawnEgg(item)
          : un.contains("ENCHANTED_BOOK") ? matchEnchantedBook(item)
              : un.contains("POTION") ? matchPotion(item) : match(un) : null;
    }
    return null;
  }
  ...
  public static UMaterial getItem(Block block) {
    ...
    UMaterial t = null;
    if (!EIGHT && !NINE && !TEN && !ELEVEN && !TWELVE || m.contains("TERRACOTTA") || m
        .startsWith("TORCH") || m.startsWith("REDSTONE_TORCH") || m.contains("STAIRS") || m
        .equals("FLINT_AND_STEEL") || m.equals("SOIL") || m.equals("LADDER") || m
        .equals("BONE_BLOCK") || m.equals("OBSERVER") || m.contains("FENCE_GATE") || m
        .contains("TRAPDOOR") || m.contains("CHEST")
        || m.equals("DISPENSER") || m.equals("DROPPER") || m.equals("JACK_O_LANTERN") || m
        .equals("PUMPKIN") || m.equals("HAY_BLOCK") || m.contains("SHULKER_BOX") || m
        .equals("LEVER") || m.contains("BUTTON") || m.contains("RAIL") || m.equals("FURNACE") || m
        .equals("VINE") || m.equals("TRIPWIRE_HOOK") || m.equals("HOPPER") || m.equals("END_ROD")) {
      return match(m);
      ...
      t = match(
          l.getSpecies().name().replace("GENERIC", "OAK").replace("REDWOOD", "SPRUCE") + "_LEAVES");
    } else if (m.contains("SAPLING")) {
      if (EIGHT) {
        t = match("SAPLING", d);
      } else {
        final org.bukkit.material.Sapling s = new org.bukkit.material.Sapling(type, d);
        t = match(s.getSpecies().name().replace("GENERIC", "OAK").replace("REDWOOD", "SPRUCE")
            + "_SAPLING");
      }
      ...
      t = match(
          s.getSpecies().name().replace("GENERIC", "OAK").replace("REDWOOD", "SPRUCE") + "_SLAB");
  ...
  public ItemStack getItemStack() {
    ...
    ItemStack is = m != null ? EIGHT || NINE || TEN || ELEVEN || TWELVE ? new ItemStack(m, 1, data)
        : new ItemStack(m) : null;
    if (is != null && attributes != null) {
      for (String s : attributes.split(";")) {
        if (s.startsWith("color=")) {
          ...
          me.setColor(Color
              .fromRGB(Integer.parseInt(a[0]), Integer.parseInt(a[1]), Integer.parseInt(a[2])));
          is.setItemMeta(me);
  ...
  private String setupVersionName() {
    final int ver = EIGHT ? 0 : NINE ? 1 : TEN ? 2
        : ELEVEN ? 3 : TWELVE ? 4 : THIRTEEN ? 5 : FOURTEEN ? 6 : FIFTEEN ? 7 : names.length - 1;
...
class UPotion implements Versionable {
  ...
  public UPotion(UMaterial.PotionBase base, String type, boolean extended, boolean upgraded) {
    ...
    final PotionType t =
        EIGHT && (type.equals("AWKWARD") || type.equals("LUCK") || type.equals("MUNDANE") || type
            .equals("THICK")) || (EIGHT || NINE || TEN || ELEVEN || TWELVE) && (
    ...
    if (EIGHT) {
      ...
      final ItemStack is = new ItemStack(Material.matchMaterial(bn.equals("NORMAL") ? "POTION"
          : bn.contains("ARROW") ? bn.contains("TIPPED") ? "TIPPED_ARROW" : "ARROW"
              : bn + "_POTION"));
      ...
      if (a) {
        ...
        pd = new org.bukkit.potion.PotionData(t, t.isExtendable() && extended,
            t.isUpgradeable() && upgraded);
      }
      potiondata = pd;
      if (a) {
